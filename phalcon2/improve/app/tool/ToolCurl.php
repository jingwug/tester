<?php
/***************************************
*$File: app/controllers/ToolCurl.php
*$Description:
*$Author: ZhangBin
*$Time:  2015/4/19
****************************************/
 class ToolCurl{
      ...
      *
      * Returns a ToolCurlResponse object if the request was successful, false otherwise
      *
      * @param string $url
      * @param array|string $vars
      * @return ToolCurlResponse object
      **/
      ...
      * @param string $url
      * @param array|string $vars
      * @return ToolCurlResponse|boolean
      **/
     ...
     function request($method, $url, $vars = array()) {
         ...
         if ($response) {
             $response = new ToolCurlResponse($response);
         } else {
